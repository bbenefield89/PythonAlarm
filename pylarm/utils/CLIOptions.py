...
class CLIOptions:
    ...
    def __print_cli_arg_info_error_text(self, err):
        ...
        print('Try using the "--help" command for a full list of available' +
              ' commands.\n'
              )
    ...
    def __print_cli_arg_help_info_error_text(self, err):
        print('\n\nPylarm Error Handling:')
        print(f'You appear to be looking for help on a specific command, ' +
              '{err}, but this command'
              )
        print('does not contain a help file. For more information on ' +
              'commands that do contain a'
              )
        print('help file please use the "--help" command for a full list of ' +
              'available commands.\n'
              )
        print('Example: pylarm --help\n\n')
